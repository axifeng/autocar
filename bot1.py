...
# 程序开启运行开关
start_button = Button_angel(1, "3")
start_button2 = Button_angel(1, "2")
...
def shot_target():
    ...
    servo_shot.servo_control(80, 80)
    time.sleep(1)
    # driver.run(30,30)
    # time.sleep(1)
    # driver.stop()
    if order_num == 4:
        ...
        time.sleep(1)
        driver.stop()
        servo_shot.servo_control(180, 80)
        time.sleep(1)
        motor = Motor_rotate(2, 1)
        motor.motor_rotate(-80)
        time.sleep(14)
...
if __name__ == '__main__':
    ...
    button_new_2 = Button(1, "2")

    while True:
        if button_new_2.clicked():
